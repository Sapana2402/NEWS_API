...
import static com.example.news.Utils.Contants.SCIENCE;
...
public class ScienceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.science_fragment, container, false);

        initComponents();

        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        retriveJSON(COUNTRY,SCIENCE,APIKEY);
        return view;
    ...
    private void initComponents() {
        recyclerView=view.findViewById(R.id.scienceRecycler);
    }
}
